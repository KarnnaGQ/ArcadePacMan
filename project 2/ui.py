...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("ENTER - START", SCREEN_W/2, SCREEN_H*0.48,
                         (190, 250, 255), 18, anchor_x="center")
        arcade.draw_text("H - HOW TO PLAY", SCREEN_W/2, SCREEN_H*0.42,
                         (190, 250, 255), 16, anchor_x="center")
        arcade.draw_text("ESC - QUIT", SCREEN_W/2, SCREEN_H*0.36,
                         (190, 250, 255), 16, anchor_x="center")
        arcade.draw_text(f"BEST: {self.best}", SCREEN_W/2, SCREEN_H*0.24,
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"SCORE: {self.score}", 16, SCREEN_H - 28, (190, 250, 255), 14)
        arcade.draw_text(f"LIVES: {self.lives}", 16, SCREEN_H - 50, (255, 80, 90), 12)
        arcade.draw_text(f"LEVEL: {self.level_index}/3", SCREEN_W - 16, SCREEN_H - 28, (190, 250, 255), 12, anchor_x="right")

        best_now = max(self.best, self.score)
        arcade.draw_text(f"BEST: {best_now}", SCREEN_W - 16, SCREEN_H - 50, (120, 255, 120), 12, anchor_x="right")

        if self.power_left > 0:
            arcade.draw_text(f"POWER: {self.power_left:0.1f}", SCREEN_W/2, SCREEN_H - 28, (120, 255, 120), 14, anchor_x="center")

        if self.pause:
            arcade.draw_text("PAUSED", SCREEN_W/2, SCREEN_H/2, (255,220,70), 42, anchor_x="center")
